<?php
    ...
    try {
      ...
      $sql = ("INSERT INTO news(type,media,headline,datenew,description,section,page,file,user_id) VALUES(1,'$medio','$titulo','$fechafinal','$descripcion','$seccion','0','$pathInS3',$userId)");
